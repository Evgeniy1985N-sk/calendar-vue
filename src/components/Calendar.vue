...
function setDate(y, m, d) {
  if (y && m && d) {
    ...
    // date.value = dateCurrent.getUTCFullYear() + ' ' + dateCurrent.toLocaleString('en-US', { month: 'short' }) + ' ' + dateCurrent.getDate()
    // toggleActive(d)
    // date.year = dateCurrent.getUTCFullYear()
    // date.month = dateCurrent.toLocaleString('en-US', { month: 'short' })
    // date.day = dateCurrent.getDate()
  }
}
